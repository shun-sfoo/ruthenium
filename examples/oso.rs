...
impl User {
    fn new(email: impl Into<String>, full_name: impl Into<String>) -> Self {
        User {
            email: email.into(),
...
impl Repo {
    fn new(name: impl Into<String>, public: bool) -> Self {
        Self {
            name: name.into(),
            public,
        }
...
fn main() -> Result<()> {
    ...
    let oso_repo = Repo::new("osoph/oso", true);
    ...
    println!(
        ...
        oso.is_allowed(alice.clone(), "billing", rust_repo.clone())?
    );
